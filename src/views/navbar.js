      ...
      <nav className="uk-navbar uk-fixed-navigation navbar-color">
        <ul className="uk-navbar-nav">
          ...
          <div className='connect uk-position-top-right '>
            ...
            <li className='links'> <a className='margin marginRightNav' href="https://www.facebook.com/ChitaliaTrushal/"><img src={facebookImg} alt={'<a href="https://www.facebook.com/ChitaliaTrushal/"></a>'}/></a> </li>
          </div>
        </ul>
      </nav>
    </div>
